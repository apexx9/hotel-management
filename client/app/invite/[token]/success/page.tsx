        ...
        <div className="mx-auto flex w-full max-w-[480px] flex-1 flex-col items-center justify-center">
          ...
          <div className="mt-6 text-center">
            ...
            <p className="mx-auto mt-3 max-w-sm text-sm leading-6 text-[#6B6B6B]">
              Your staff account has been created successfully. You can now sign
              in to access your hotel workspace.
            </p>
          ...
          <div className="mt-8 w-full max-w-sm">
            <Link href="/login" className="block">
              <Button className="rounded-full h-11 w-full">Sign in</Button>
            </Link>
          </div>
        </div>
