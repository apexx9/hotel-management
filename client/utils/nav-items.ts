...
export type NavItem = {
  ...
  icon: LucideIcon;
  children?: NavItem[];
  allowedRoles?: string[]; // optional list of roles allowed to see this item
};
...
export const navItems: NavItem[] = [
  ...
  { href: "/housekeeping", label: "Housekeeping", icon: Sparkles },
  {
    ...
    // Only finance, manager, admin, owner can access finance
    allowedRoles: ["finance", "manager", "admin", "owner"],
  },
  {
    href: "/settings",
    label: "Settings",
