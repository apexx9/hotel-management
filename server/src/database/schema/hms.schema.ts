...
export const guests = pgTable('guests', {
  ...
  identificationType: varchar('identification_type', { length: 80 }),
  identificationNumber: varchar('identification_number', { length: 120 }),
...
export const stays = pgTable('stays', {
  ...
  guestId: uuid('guest_id')
    .notNull()
    .references(() => guests.id, { onDelete: 'restrict', onUpdate: 'cascade' }),
  roomId: uuid('room_id')
    .notNull()
    .references(() => rooms.id, { onDelete: 'restrict', onUpdate: 'cascade' }),
  roomTypeId: uuid('room_type_id')
    .notNull()
    .references(() => roomTypes.id, {
      onDelete: 'restrict',
  ...
  serviceTotal: numeric('service_total', { precision: 12, scale: 2 })
    .notNull()
    .default('0'),
...
export const invoices = pgTable('invoices', {
  ...
  stayId: uuid('stay_id')
    .notNull()
    .references(() => stays.id, { onDelete: 'restrict', onUpdate: 'cascade' }),
  roomId: uuid('room_id')
    .notNull()
    .references(() => rooms.id, { onDelete: 'restrict', onUpdate: 'cascade' }),
